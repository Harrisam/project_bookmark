...
task :auto_upgrade do 
	...
	# If your tables don't exist, they wiill be created
	# but if they do and you change your schema
	# (e.g. changed the type of one of the properties)
	# they will not be auto_upgraded because that'd lead to data loss.
